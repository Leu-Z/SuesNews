...
public class MyRecyclerAdapter extends RecyclerView.Adapter<MyRecyclerAdapter.ViewHolder>{
    ...
    //这是每个RecyclerView里面每个view显示的图片,随机选择
...
//创建ArrayList<NewsItem>，随机选择一张图片
    ...
    /**mNewsList的唯一来源
     * 添加新闻列表,要通过这个方法添加新闻列表，在getNewsList方法里添加
     * @param news 要添加的新闻列表
     */

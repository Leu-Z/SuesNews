...
//        /如果api为19,将导航栏以及状态栏设为渐变
   ...
   protected MaterialMenuDrawable.IconState intToState(int state){
    ...
    /**
     * 是否将导航栏以及状态栏设为渐变（API大于等于19小与21,即API为19时)
     * @return
     */
...
//        );
    ...
    // 使高版本API的代码在低版本SDK不报错,这里的高版本pai是3.0
    //这里新加的方法是在api3.0里的，就算最小sdk小于3.0，也不会报错
    @TargetApi(Build.VERSION_CODES.HONEYCOMB)  //替代碎片，3.0
